...
public abstract class DefaultFactory implements WirJavaConventionFactory {
    public static class Builder {
        ...
        class Impl extends DefaultFactory {
            @Override
                ...
                public void preConvert() {
                    ...
                    if (node.datas != null) {
                        ...
                        for (DataNode data : node.datas) {
                            ...
                            fillWithDirectPuts(data, dIb, slicedV);
    ...
    private static void fillWithDirectPuts(DataNode data, IRBuilder ib, Var dataV) {
