 ...
 * @see WirJavaConventionFactory.Builder#setModifyFuncConvention(ConventionModifier)
 * @see WirJavaConventionFactory.Builder#setModifyGlobalConvention(ConventionModifier)
 * @see WirJavaConventionFactory.Builder#setModifyMemConvention(ConventionModifier)
 * @see WirJavaConventionFactory.Builder#setModifyTableConvention(ConventionModifier)
 */
