 ...
 * contains {@link io.github.eutro.wasm2j.ops.WasmOps WebAssembly operations},
 * has {@link io.github.eutro.wasm2j.ext.WasmExts WebAssembly extensions}, and
 * has its functions aggregated in an {@link io.github.eutro.wasm2j.ssa.Module WebAssembly module}.
 * <p>
 * "Java IR", on the other hand, may have been parsed from Java bytecode, or
 * converted from WebAssembly IR. It contains
 * {@link io.github.eutro.wasm2j.ops.JavaOps Java operations}, has
 * {@link io.github.eutro.wasm2j.ext.JavaExts Java extensions}, and
 * has its functions aggregated in {@link io.github.eutro.wasm2j.ssa.JClass Java classes}.
 * <p>
 ...
 * That is, each {@link io.github.eutro.wasm2j.ssa.Var}
 * is assigned to by <i>exactly</i> one {@link io.github.eutro.wasm2j.ssa.Effect}
 ...
 * in {@link io.github.eutro.wasm2j.passes.convert}.
 */
